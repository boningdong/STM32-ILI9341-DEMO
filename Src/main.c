...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, LCD_IM0_Pin|LCD_IM1_Pin|LCD_IM2_Pin|LCD_IM3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LCD_IM0_Pin LCD_IM1_Pin LCD_IM2_Pin LCD_IM3_Pin */
  GPIO_InitStruct.Pin = LCD_IM0_Pin|LCD_IM1_Pin|LCD_IM2_Pin|LCD_IM3_Pin;
